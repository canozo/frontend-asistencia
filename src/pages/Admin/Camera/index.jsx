...
const Camera = ({ token }) => {
  ...
  useEffect(() => {
    ...
    api('/camera', 'get', undefined, token, ac.signal)
  ...
  const submit = async event => {
    ...
    try {
      ...
      const res = await api('/camera', 'post', payload, token);
      setList([...list, {
        idUser: res.id,
        names,
        surnames,
  ...
  return (
    <div className="container-fluid fade-in">
      ...
      <h3 className="mb-4">
        Camaras
        <br />
        <small className="text-muted">Modificar datos de usuarios de camaras</small>
      </h3>
      ...
      <Form onSubmit={submit}>
        ...
        <div className="row">
          <div className="col-lg-6">
            {/* Email */}
            <Form.Group controlId="camera-email">
              ...
              <InputGroup>
                ...
                />
                <InputGroup.Append>
                  <InputGroup.Text id="camera-group-email">@unitec.edu</InputGroup.Text>
                </InputGroup.Append>
              </InputGroup>
            </Form.Group>
          </div>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="modal-camera">
            Confirmación eliminar usuario
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ¿Estás segur@ de que deseas eliminar el usuario? Una vez eliminado, no podrá ser recuperado.
        </Modal.Body>
        <Modal.Footer>
